...
from models.prompt_generator_test_zero_shot import PromptGenerator,PromptGeneratorlimzero,PromptGeneratorConv
...
class PGVP(nn.Module):
    ...
    def forward(self, support_img, support_mask, query_img, query_mask, grid, query_features, support_features,need_pred):
        ...
        return loss_zzh, canvas_pred_tokens, canvas_return_label

...
from evaluate_detection.image_level_canvas_ds import CanvasDataset4Train, CanvasDataset4Val
...
def get_args():
    ...
    parser.add_argument('--task', default='image-level_detection', choices=['segmentation', 'detection'])

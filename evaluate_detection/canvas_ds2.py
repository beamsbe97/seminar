...
import sys
sys.path.append('/data/luotianci/InMeMo_4.0/evaluate_detection')
# print(sys.path)
...
class CanvasDataset4Val(data.Dataset):
    def __init__(self, pascal_path='pascal-5i',args = None, years=("2012",),simidx = 1, random=False, **kwargs):
        ...
        self.img_feature_for_train_path = '/data/luotianci/InMeMo_4.0/pascal-5i/VOC2012/features_vit-laion2b_pixel-level_query_all_detection/detection_eval_query.h5df'
        self.support_feature_for_train_path = '/data/luotianci/InMeMo_4.0/pascal-5i/VOC2012/features_vit-laion2b_pixel-level_support_all_detection/detection_eval_support.h5df'
        self.args = args

    def get_top50_images(self):
        with open('./pascal-5i/VOC2012/features_vit-laion2b_pixel-level_val_all_detection/new_top_50-similarity.json') as f:
    ...
    def __getitem__(self, idx):
        grids = torch.tensor([]).to('cuda:2')
        support_imgs = torch.tensor([]).to('cuda:2')
        support_masks = torch.tensor([]).to('cuda:2')
        query_img_features = torch.tensor([]).to('cuda:2')
        support_features = torch.tensor([]).to('cuda:2')
...
class CanvasDataset4Train(data.Dataset):
    def __init__(self, pascal_path='pascal-5i', args = None,years=("2012",), simidx = 1, random=False, **kwargs):
        ...
        self.simidx = simidx
        self.images_top50 = self.get_top50_images()
        self.img_feature_for_train_path = '/data/luotianci/InMeMo_4.0/pascal-5i/VOC2012/features_vit-laion2b_pixel-level_query_all_detection/detection_train_query.h5df'
        self.support_feature_for_train_path = '/data/luotianci/InMeMo_4.0/pascal-5i/VOC2012/features_vit-laion2b_pixel-level_support_all_detection/detection_train_support.h5df'
        self.args = args
    def get_top50_images(self):
        with open('./pascal-5i/VOC2012/features_vit-laion2b_pixel-level_train_all_detection/new_top_50-similarity.json') as f:
            images_top50 = json.load(f)
        return images_top50

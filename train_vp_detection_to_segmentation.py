...
def train(args):
    ...
    task = f'_task_det_to_seg_{args.choice}_align_q{args.align_q}'
    ...
    val_dataset =val_pascal_dataloader.DatasetPASCAL(args.base_dir, args=args, fold=args.fold, split=args.split, image_transform=image_transform,

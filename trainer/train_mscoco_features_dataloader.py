...
class DatasetMSCOCO(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        vq_tokens = []
        #end my code
        query_name, _, class_sample_query, _ = self.sample_episode_for_training(idx, sim_idx=0)
        ...
        for sim_idx in range(self.simidx):
            _, support_name, _, class_sample_support = self.sample_episode_for_training(idx, sim_idx=sim_idx)

...
class DatasetPASCAL(Dataset):
    def __init__(self, datapath, args, fold, split, image_transform, mask_transform, padding: bool = 1,
                 ...
                 selected_label: int = 0, simidx: int = 1, se: bool = False):
        ...
        ##my code
        self.img_feature_for_train_path = os.path.join(datapath, f'VOC2012/{self.feature_name}/folder{self.fold}_query_features_zero_shot_by_vqgan_encoder.h5df')
        self.support_feature_for_train_path = os.path.join(datapath, f'VOC2012/{self.feature_name}/folder{self.fold}_features_zero_shot_by_vqgan_encoder.h5df')
        ##end my code
        #my code
            ...
            if sim_idx == 0:
                ...
                if self.se:
                    ...
                    batch = {'query_img': query_img,
                        ...
                        'support_imgs': query_img.unsqueeze(0),
                        'support_masks': query_mask.unsqueeze(0),
                        'grids': grids,
                        'name': name,
                        ##my code
